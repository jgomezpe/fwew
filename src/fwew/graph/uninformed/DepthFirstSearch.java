 ...
 * @version 1.0
 */
public class DepthFirstSearch<T,O> extends ClassicSearch<T,O> {
    public DepthFirstSearch( GoalTest<T> goal ) { super(goal); }
    public DepthFirstSearch( GoalTest<T> goal, int _max_depth ) {
